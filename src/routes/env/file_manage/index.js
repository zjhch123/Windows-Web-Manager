    ...
    return (
      <div className={styles['g-container']}>
        <div className={styles['m-manage']}>
          ...
          <div className={styles['u-switch']}>
            <span>显示隐藏目录?</span> <Switch defaultChecked/>
          </div>
        </div>
        <Table 
        ...
        <div className={styles['m-manage']}>
          <div className={styles['m-action']}>
            <Button className={styles['u-btn']}>批量复制</Button>
            <Button className={styles['u-btn']}>批量剪切</Button>
            <Button className={styles['u-btn']}>批量删除</Button>
            <Button className={styles['u-btn']}>批量打包压缩</Button>
            <Button className={styles['u-btn']}>批量修改用户和组</Button>
            <Button className={styles['u-btn']}>批量修改权限</Button>
          </div>
        </div>
      </div>
    )
